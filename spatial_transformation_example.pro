...
original_image = GAUSSIAN_2(x_size_1, y_size_1, sigma_x_1, sigma_y_1)
...
; Set palette representation for every display
...
win_title = '2-D Gaussian -- Original Image'
...
; Open window
WINDOW, 1, XSIZE = x_standard_size, YSIZE = y_standard_size, $
...
plot_win_x = !X.WINDOW * !D.X_VSIZE
plot_win_y = !Y.WINDOW * !D.Y_VSIZE

; Define size of image to fit the plot window
image_x_size = plot_win_x[1] - plot_win_x[0] + 1
image_y_size = plot_win_y[1] - plot_win_y[0] + 1

; Display original image rebinned according to new size
TV, CONGRID(original_image, image_x_size, image_y_size), plot_win_x[0], plot_win_y[0]
...
undersampled_image = SPATIAL_TRANSFORMATION(original_image, /UNDERSAMPLE, REBIN_FACTOR=rebin_factor)

x_size_2 = (SIZE(undersampled_image, /DIMENSIONS))[0]
y_size_2 = (SIZE(undersampled_image, /DIMENSIONS))[1]
...
; Draw 2-D plots
VIS_2D, original_image, undersampled_image,          $
        x_standard_size, y_standard_size,            $
        win_title,                                   $              
        title_1,                                     $
        x_title_1, y_title_1,                        $
        title_2,                                     $
...
integer_oversampled_image = SPATIAL_TRANSFORMATION(original_image,              $
                                                   /OVERSAMPLE,                 $
                                                   REBIN_FACTOR = rebin_factor)

; Calculate final size
x_size_2 = (SIZE(integer_oversampled_image, /DIMENSIONS))[0]
y_size_2 = (SIZE(integer_oversampled_image, /DIMENSIONS))[1]
...
; Draw 2-D plots
VIS_2D, original_image,                                      $
        integer_oversampled_image,                           $
        x_standard_size, y_standard_size,                    $
        win_title,                                           $
...
real_nearest_oversampled_image = SPATIAL_TRANSFORMATION(original_image,              $
                                                        /OVERSAMPLE,                 $
                                                        REBIN_FACTOR = rebin_factor, $
                                                        /NEAREST_NEIGHBOUR)

x_size_2 = (SIZE(real_nearest_oversampled_image, /DIMENSIONS))[0]
y_size_2 = (SIZE(real_nearest_oversampled_image, /DIMENSIONS))[1]
...
; Draw 2-D plots
VIS_2D, original_image,                                      $
        real_nearest_oversampled_image,                      $
        x_standard_size, y_standard_size,                    $
        win_title,                                           $
        title_1, x_title_1, y_title_1,                       $
        title_2, x_title_2, y_title_2
...
real_bilinear_oversampled_image = SPATIAL_TRANSFORMATION(original_image,              $
                                                         /OVERSAMPLE,                 $
                                                         REBIN_FACTOR = rebin_factor, $
                                                         /BILINEAR)

x_size_2 = (SIZE(real_bilinear_oversampled_image, /DIMENSIONS))[0]
y_size_2 = (SIZE(real_bilinear_oversampled_image, /DIMENSIONS))[1]
...
; Draw 2-D plots
VIS_2D, original_image,                                      $
        real_bilinear_oversampled_image,                     $
        x_standard_size, y_standard_size,                    $
        win_title,                                           $
        title_1, x_title_1, y_title_1,                       $
        title_2, x_title_2, y_title_2
...
nearest_transrot_image = SPATIAL_TRANSFORMATION(original_image,                       $
                                                /TRANSROT,                   $
                                                TRANS_VALUES = trans_values, $
                                                ROT_VALUE = theta,           $
                                                /NEAREST_NEIGHBOUR)

x_size_2 = (SIZE(nearest_transrot_image, /DIMENSIONS))[0]
y_size_2 = (SIZE(nearest_transrot_image, /DIMENSIONS))[1]
...
bilinear_transrot_image = SPATIAL_TRANSFORMATION(original_image,                       $
                                                 /TRANSROT,                   $
                                                 TRANS_VALUES = trans_values, $
                                                 ROT_VALUE = theta,           $
                                                 /BILINEAR)

x_size_2 = (SIZE(bilinear_transrot_image, /DIMENSIONS))[0]
y_size_2 = (SIZE(bilinear_transrot_image, /DIMENSIONS))[1]
